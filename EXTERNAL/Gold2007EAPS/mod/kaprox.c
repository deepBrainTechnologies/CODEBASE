...
#define nrn_init _nrn_init__kaprox
#define _nrn_initial _nrn_initial__kaprox
#define nrn_cur _nrn_cur__kaprox
#define _nrn_current _nrn_current__kaprox
#define nrn_jacob _nrn_jacob__kaprox
#define nrn_state _nrn_state__kaprox
#define _net_receive _net_receive__kaprox 
#define rates rates__kaprox 
#define states states__kaprox 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kaprox", _hoc_setdata,
 "rates_kaprox", _hoc_rates,
 "var_tau_kaprox", _hoc_var_tau,
 "var_inf_kaprox", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_kaprox
#define var_inf var_inf_kaprox
...
#define exp_h exp_h_kaprox
 double exp_h = 0;
#define exp_m exp_m_kaprox
 double exp_m = 0;
#define toffset_h toffset_h_kaprox
 double toffset_h = 0;
#define tscale_h tscale_h_kaprox
 double tscale_h = 0;
#define tskew_h tskew_h_kaprox
 double tskew_h = 0;
#define toffset_m toffset_m_kaprox
 double toffset_m = 0;
#define tscale_m tscale_m_kaprox
 double tscale_m = 0;
#define tskew_m tskew_m_kaprox
 double tskew_m = 0;
#define vsteep_h vsteep_h_kaprox
 double vsteep_h = 0;
#define vhalf_h vhalf_h_kaprox
 double vhalf_h = 0;
#define vsteep_m vsteep_m_kaprox
 double vsteep_m = 0;
#define vhalf_m vhalf_m_kaprox
 double vhalf_m = 0;
 ...
 "vhalf_m_kaprox", &vhalf_m_kaprox,
 "vsteep_m_kaprox", &vsteep_m_kaprox,
 "tskew_m_kaprox", &tskew_m_kaprox,
 "tscale_m_kaprox", &tscale_m_kaprox,
 "toffset_m_kaprox", &toffset_m_kaprox,
 "exp_m_kaprox", &exp_m_kaprox,
 "vhalf_h_kaprox", &vhalf_h_kaprox,
 "vsteep_h_kaprox", &vsteep_h_kaprox,
 "tskew_h_kaprox", &tskew_h_kaprox,
 "tscale_h_kaprox", &tscale_h_kaprox,
 "toffset_h_kaprox", &toffset_h_kaprox,
 "exp_h_kaprox", &exp_h_kaprox,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kaprox kaprox.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KAPROX";
