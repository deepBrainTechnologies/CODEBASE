...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "do_exp_kahp", _hoc_do_exp,
 "rates_kahp", _hoc_rates,
 0, 0
};
#define do_exp do_exp_kahp
 extern double do_exp( _threadargsprotocomma_ double , double );
 /* declare global and static user variables */
#define alpha_n alpha_n_kahp
 double alpha_n = 0;
#define beta_n beta_n_kahp
 double beta_n = 0;
#define exp_ca exp_ca_kahp
 double exp_ca = 0;
#define exp_n exp_n_kahp
 double exp_n = 0;
#define toffset_n toffset_n_kahp
 double toffset_n = 0;
 ...
 "exp_n_kahp", &exp_n_kahp,
 "exp_ca_kahp", &exp_ca_kahp,
 "alpha_n_kahp", &alpha_n_kahp,
 "beta_n_kahp", &beta_n_kahp,
 "toffset_n_kahp", &toffset_n_kahp,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kahp kahp.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KAHP";
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   double _lcai_to_power ;
 _lcai_to_power = do_exp ( _threadargscomma_ cai , exp_ca ) ;
   ninf = ( alpha_n * _lcai_to_power ) / ( alpha_n * _lcai_to_power + beta_n ) ;
   ntau = 1.0 / ( alpha_n * _lcai_to_power + beta_n ) + toffset_n ;
    return 0; }
...
double do_exp ( _threadargsprotocomma_ double _lvar , double _lgexp ) {
   double _ldo_exp;
 _ldo_exp = 1.0 ;
   {int  _li ;for ( _li = 1 ; _li <= ((int) _lgexp ) ; _li ++ ) {
     _ldo_exp = _ldo_exp * _lvar ;
     } }
...
static void _hoc_do_exp(void) {
  ...
  _thread = _extcall_thread;
  _nt = nrn_threads;
 _r =  do_exp ( _p, _ppvar, _thread, _nt, *getarg(1) , *getarg(2) );
 hoc_retpushx(_r);
}
...
static void initmodel(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt) {
  ...
  n = n0;
 {
   ...
   n = ninf ;
   ik = gbar * do_exp ( _threadargscomma_ n , exp_n ) * ( v - ek ) ;
   }
