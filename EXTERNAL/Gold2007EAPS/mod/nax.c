...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "var_tau_nax", _hoc_var_tau,
 "var_inf_nax", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_nax
#define var_inf var_inf_nax
...
#define exp_h exp_h_nax
 double exp_h = 0;
#define exp_m exp_m_nax
 double exp_m = 0;
#define toffset_h toffset_h_nax
 double toffset_h = 0;
#define tscale_h tscale_h_nax
 double tscale_h = 0;
#define tskew_h tskew_h_nax
 double tskew_h = 0;
#define toffset_m toffset_m_nax
 double toffset_m = 0;
#define tscale_m tscale_m_nax
 double tscale_m = 0;
#define tskew_m tskew_m_nax
 double tskew_m = 0;
#define vsteep_h vsteep_h_nax
 double vsteep_h = 0;
#define vhalf_h vhalf_h_nax
 double vhalf_h = 0;
#define vsteep_m vsteep_m_nax
 double vsteep_m = 0;
#define vhalf_m vhalf_m_nax
 double vhalf_m = 0;
 ...
 "vhalf_m_nax", &vhalf_m_nax,
 "vsteep_m_nax", &vsteep_m_nax,
 "tskew_m_nax", &tskew_m_nax,
 "tscale_m_nax", &tscale_m_nax,
 "toffset_m_nax", &toffset_m_nax,
 "exp_m_nax", &exp_m_nax,
 "vhalf_h_nax", &vhalf_h_nax,
 "vsteep_h_nax", &vsteep_h_nax,
 "tskew_h_nax", &tskew_h_nax,
 "tscale_h_nax", &tscale_h_nax,
 "toffset_h_nax", &toffset_h_nax,
 "exp_h_nax", &exp_h_nax,
 0,0
};
...
static int _reset;
static char *modelname = "Fast NA Axonal";
