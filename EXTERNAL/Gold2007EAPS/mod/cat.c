...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "var_tau_cat", _hoc_var_tau,
 "var_inf_cat", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_cat
#define var_inf var_inf_cat
...
#define exp_h exp_h_cat
 double exp_h = 0;
#define exp_m exp_m_cat
 double exp_m = 0;
#define toffset_h toffset_h_cat
 double toffset_h = 0;
#define tscale_h tscale_h_cat
 double tscale_h = 0;
#define tskew_h tskew_h_cat
 double tskew_h = 0;
#define toffset_m toffset_m_cat
 double toffset_m = 0;
#define tscale_m tscale_m_cat
 double tscale_m = 0;
#define tskew_m tskew_m_cat
 double tskew_m = 0;
#define vsteep_h vsteep_h_cat
 double vsteep_h = 0;
#define vhalf_h vhalf_h_cat
 double vhalf_h = 0;
#define vsteep_m vsteep_m_cat
 double vsteep_m = 0;
#define vhalf_m vhalf_m_cat
 double vhalf_m = 0;
 ...
 "vhalf_m_cat", &vhalf_m_cat,
 "vsteep_m_cat", &vsteep_m_cat,
 "tskew_m_cat", &tskew_m_cat,
 "tscale_m_cat", &tscale_m_cat,
 "toffset_m_cat", &toffset_m_cat,
 "exp_m_cat", &exp_m_cat,
 "vhalf_h_cat", &vhalf_h_cat,
 "vsteep_h_cat", &vsteep_h_cat,
 "tskew_h_cat", &tskew_h_cat,
 "tscale_h_cat", &tscale_h_cat,
 "toffset_h_cat", &toffset_h_cat,
 "exp_h_cat", &exp_h_cat,
 0,0
};
