...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "var_tau_cal", _hoc_var_tau,
 "var_inf_cal", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_cal
#define var_inf var_inf_cal
...
#define exp_n exp_n_cal
 double exp_n = 0;
#define toffset_n toffset_n_cal
 double toffset_n = 0;
#define tscale_n tscale_n_cal
 double tscale_n = 0;
#define tskew_n tskew_n_cal
 double tskew_n = 0;
#define vsteep_n vsteep_n_cal
 double vsteep_n = 0;
#define vhalf_n vhalf_n_cal
 double vhalf_n = 0;
 ...
 "vhalf_n_cal", &vhalf_n_cal,
 "vsteep_n_cal", &vsteep_n_cal,
 "tskew_n_cal", &tskew_n_cal,
 "tscale_n_cal", &tscale_n_cal,
 "toffset_n_cal", &toffset_n_cal,
 "exp_n_cal", &exp_n_cal,
 0,0
};
...
static const char* nmodl_file_text = 
  ...
  "	n = ninf\n"
  "}\n"
  ":::end INCLUDE noinact_ca_currs.inc\n"
  "\n"
