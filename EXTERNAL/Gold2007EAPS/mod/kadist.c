...
#define nrn_init _nrn_init__kadist
#define _nrn_initial _nrn_initial__kadist
#define nrn_cur _nrn_cur__kadist
#define _nrn_current _nrn_current__kadist
#define nrn_jacob _nrn_jacob__kadist
#define nrn_state _nrn_state__kadist
#define _net_receive _net_receive__kadist 
#define rates rates__kadist 
#define states states__kadist 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kadist", _hoc_setdata,
 "rates_kadist", _hoc_rates,
 "var_tau_kadist", _hoc_var_tau,
 "var_inf_kadist", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_kadist
#define var_inf var_inf_kadist
...
#define exp_h exp_h_kadist
 double exp_h = 0;
#define exp_m exp_m_kadist
 double exp_m = 0;
#define toffset_h toffset_h_kadist
 double toffset_h = 0;
#define tscale_h tscale_h_kadist
 double tscale_h = 0;
#define tskew_h tskew_h_kadist
 double tskew_h = 0;
#define toffset_m toffset_m_kadist
 double toffset_m = 0;
#define tscale_m tscale_m_kadist
 double tscale_m = 0;
#define tskew_m tskew_m_kadist
 double tskew_m = 0;
#define vsteep_h vsteep_h_kadist
 double vsteep_h = 0;
#define vhalf_h vhalf_h_kadist
 double vhalf_h = 0;
#define vsteep_m vsteep_m_kadist
 double vsteep_m = 0;
#define vhalf_m vhalf_m_kadist
 double vhalf_m = 0;
 ...
 "vhalf_m_kadist", &vhalf_m_kadist,
 "vsteep_m_kadist", &vsteep_m_kadist,
 "tskew_m_kadist", &tskew_m_kadist,
 "tscale_m_kadist", &tscale_m_kadist,
 "toffset_m_kadist", &toffset_m_kadist,
 "exp_m_kadist", &exp_m_kadist,
 "vhalf_h_kadist", &vhalf_h_kadist,
 "vsteep_h_kadist", &vsteep_h_kadist,
 "tskew_h_kadist", &tskew_h_kadist,
 "tscale_h_kadist", &tscale_h_kadist,
 "toffset_h_kadist", &toffset_h_kadist,
 "exp_h_kadist", &exp_h_kadist,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kadist kadist.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KADIST";
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ik = gbar * ( pow( m , exp_m ) ) * ( pow( h , exp_h ) ) * ( v - ek ) ;
   }
 _current += ik;
