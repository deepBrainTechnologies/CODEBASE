...
#define nrn_init _nrn_init__hdend
#define _nrn_initial _nrn_initial__hdend
#define nrn_cur _nrn_cur__hdend
#define _nrn_current _nrn_current__hdend
#define nrn_jacob _nrn_jacob__hdend
#define nrn_state _nrn_state__hdend
#define _net_receive _net_receive__hdend 
#define rates rates__hdend 
#define states states__hdend 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hdend", _hoc_setdata,
 "rates_hdend", _hoc_rates,
 "var_tau_hdend", _hoc_var_tau,
 "var_inf_hdend", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_hdend
#define var_inf var_inf_hdend
...
#define exp_n exp_n_hdend
 double exp_n = 0;
#define toffset_n toffset_n_hdend
 double toffset_n = 0;
#define tscale_n tscale_n_hdend
 double tscale_n = 0;
#define tskew_n tskew_n_hdend
 double tskew_n = 0;
#define vsteep_n vsteep_n_hdend
 double vsteep_n = 0;
#define vhalf_n vhalf_n_hdend
 double vhalf_n = 0;
 ...
 "vhalf_n_hdend", &vhalf_n_hdend,
 "vsteep_n_hdend", &vsteep_n_hdend,
 "tskew_n_hdend", &tskew_n_hdend,
 "tscale_n_hdend", &tscale_n_hdend,
 "toffset_n_hdend", &toffset_n_hdend,
 "exp_n_hdend", &exp_n_hdend,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 hdend hdend.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "HDEND";
...
#if NMODL_TEXT
static const char* nmodl_filename = "hdend.mod";
static const char* nmodl_file_text = 
  ...
  "	n = ninf\n"
  "}\n"
  ":::end INCLUDE noinact_nak_currs.inc\n"
  "\n"
