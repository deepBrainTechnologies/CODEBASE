...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "var_tau_car", _hoc_var_tau,
 "var_inf_car", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_car
#define var_inf var_inf_car
...
#define exp_h exp_h_car
 double exp_h = 0;
#define exp_m exp_m_car
 double exp_m = 0;
#define toffset_h toffset_h_car
 double toffset_h = 0;
#define tscale_h tscale_h_car
 double tscale_h = 0;
#define tskew_h tskew_h_car
 double tskew_h = 0;
#define toffset_m toffset_m_car
 double toffset_m = 0;
#define tscale_m tscale_m_car
 double tscale_m = 0;
#define tskew_m tskew_m_car
 double tskew_m = 0;
#define vsteep_h vsteep_h_car
 double vsteep_h = 0;
#define vhalf_h vhalf_h_car
 double vhalf_h = 0;
#define vsteep_m vsteep_m_car
 double vsteep_m = 0;
#define vhalf_m vhalf_m_car
 double vhalf_m = 0;
 ...
 "vhalf_m_car", &vhalf_m_car,
 "vsteep_m_car", &vsteep_m_car,
 "tskew_m_car", &tskew_m_car,
 "tscale_m_car", &tscale_m_car,
 "toffset_m_car", &toffset_m_car,
 "exp_m_car", &exp_m_car,
 "vhalf_h_car", &vhalf_h_car,
 "vsteep_h_car", &vsteep_h_car,
 "tskew_h_car", &tskew_h_car,
 "tscale_h_car", &tscale_h_car,
 "toffset_h_car", &toffset_h_car,
 "exp_h_car", &exp_h_car,
 0,0
};
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = gbar * ( pow( m , exp_m ) ) * ( pow( h , exp_h ) ) * ( v - eca ) ;
   }
 _current += ica;
...
static const char* nmodl_file_text = 
  ...
  "	h = hinf\n"
  "}\n"
  ":::end INCLUDE inact_ca_currs.inc\n"
  "\n"
