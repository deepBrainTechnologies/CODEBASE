...
#define nrn_init _nrn_init__kk
#define _nrn_initial _nrn_initial__kk
#define nrn_cur _nrn_cur__kk
#define _nrn_current _nrn_current__kk
#define nrn_jacob _nrn_jacob__kk
#define nrn_state _nrn_state__kk
#define _net_receive _net_receive__kk 
#define rates rates__kk 
#define states states__kk 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kk", _hoc_setdata,
 "rates_kk", _hoc_rates,
 "var_tau_kk", _hoc_var_tau,
 "var_inf_kk", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_kk
#define var_inf var_inf_kk
...
#define exp_h exp_h_kk
 double exp_h = 0;
#define exp_m exp_m_kk
 double exp_m = 0;
#define toffset_h toffset_h_kk
 double toffset_h = 0;
#define tscale_h tscale_h_kk
 double tscale_h = 0;
#define tskew_h tskew_h_kk
 double tskew_h = 0;
#define toffset_m toffset_m_kk
 double toffset_m = 0;
#define tscale_m tscale_m_kk
 double tscale_m = 0;
#define tskew_m tskew_m_kk
 double tskew_m = 0;
#define vsteep_h vsteep_h_kk
 double vsteep_h = 0;
#define vhalf_h vhalf_h_kk
 double vhalf_h = 0;
#define vsteep_m vsteep_m_kk
 double vsteep_m = 0;
#define vhalf_m vhalf_m_kk
 double vhalf_m = 0;
 ...
 "vhalf_m_kk", &vhalf_m_kk,
 "vsteep_m_kk", &vsteep_m_kk,
 "tskew_m_kk", &tskew_m_kk,
 "tscale_m_kk", &tscale_m_kk,
 "toffset_m_kk", &toffset_m_kk,
 "exp_m_kk", &exp_m_kk,
 "vhalf_h_kk", &vhalf_h_kk,
 "vsteep_h_kk", &vsteep_h_kk,
 "tskew_h_kk", &tskew_h_kk,
 "tscale_h_kk", &tscale_h_kk,
 "toffset_h_kk", &toffset_h_kk,
 "exp_h_kk", &exp_h_kk,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kk kk.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "KK";
...
#if NMODL_TEXT
static const char* nmodl_filename = "kk.mod";
static const char* nmodl_file_text = 
