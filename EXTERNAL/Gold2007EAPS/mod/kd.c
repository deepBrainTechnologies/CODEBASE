...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "rates_kd", _hoc_rates,
 "var_tau_kd", _hoc_var_tau,
 "var_inf_kd", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_kd
#define var_inf var_inf_kd
...
#define exp_h exp_h_kd
 double exp_h = 0;
#define exp_m exp_m_kd
 double exp_m = 0;
#define toffset_h toffset_h_kd
 double toffset_h = 0;
#define tscale_h tscale_h_kd
 double tscale_h = 0;
#define tskew_h tskew_h_kd
 double tskew_h = 0;
#define toffset_m toffset_m_kd
 double toffset_m = 0;
#define tscale_m tscale_m_kd
 double tscale_m = 0;
#define tskew_m tskew_m_kd
 double tskew_m = 0;
#define vsteep_h vsteep_h_kd
 double vsteep_h = 0;
#define vhalf_h vhalf_h_kd
 double vhalf_h = 0;
#define vsteep_m vsteep_m_kd
 double vsteep_m = 0;
#define vhalf_m vhalf_m_kd
 double vhalf_m = 0;
 ...
 "vhalf_m_kd", &vhalf_m_kd,
 "vsteep_m_kd", &vsteep_m_kd,
 "tskew_m_kd", &tskew_m_kd,
 "tscale_m_kd", &tscale_m_kd,
 "toffset_m_kd", &toffset_m_kd,
 "exp_m_kd", &exp_m_kd,
 "vhalf_h_kd", &vhalf_h_kd,
 "vsteep_h_kd", &vsteep_h_kd,
 "tskew_h_kd", &tskew_h_kd,
 "tscale_h_kd", &tscale_h_kd,
 "toffset_h_kd", &toffset_h_kd,
 "exp_h_kd", &exp_h_kd,
 0,0
};
