...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "var_tau_can", _hoc_var_tau,
 "var_inf_can", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_can
#define var_inf var_inf_can
...
#define exp_h exp_h_can
 double exp_h = 0;
#define exp_m exp_m_can
 double exp_m = 0;
#define toffset_h toffset_h_can
 double toffset_h = 0;
#define tscale_h tscale_h_can
 double tscale_h = 0;
#define tskew_h tskew_h_can
 double tskew_h = 0;
#define toffset_m toffset_m_can
 double toffset_m = 0;
#define tscale_m tscale_m_can
 double tscale_m = 0;
#define tskew_m tskew_m_can
 double tskew_m = 0;
#define vsteep_h vsteep_h_can
 double vsteep_h = 0;
#define vhalf_h vhalf_h_can
 double vhalf_h = 0;
#define vsteep_m vsteep_m_can
 double vsteep_m = 0;
#define vhalf_m vhalf_m_can
 double vhalf_m = 0;
 ...
 "vhalf_m_can", &vhalf_m_can,
 "vsteep_m_can", &vsteep_m_can,
 "tskew_m_can", &tskew_m_can,
 "tscale_m_can", &tscale_m_can,
 "toffset_m_can", &toffset_m_can,
 "exp_m_can", &exp_m_can,
 "vhalf_h_can", &vhalf_h_can,
 "vsteep_h_can", &vsteep_h_can,
 "tskew_h_can", &tskew_h_can,
 "tscale_h_can", &tscale_h_can,
 "toffset_h_can", &toffset_h_can,
 "exp_h_can", &exp_h_can,
 0,0
};
