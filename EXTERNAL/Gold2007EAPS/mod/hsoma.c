...
#define nrn_init _nrn_init__hsoma
#define _nrn_initial _nrn_initial__hsoma
#define nrn_cur _nrn_cur__hsoma
#define _nrn_current _nrn_current__hsoma
#define nrn_jacob _nrn_jacob__hsoma
#define nrn_state _nrn_state__hsoma
#define _net_receive _net_receive__hsoma 
#define rates rates__hsoma 
#define states states__hsoma 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hsoma", _hoc_setdata,
 "rates_hsoma", _hoc_rates,
 "var_tau_hsoma", _hoc_var_tau,
 "var_inf_hsoma", _hoc_var_inf,
 0, 0
};
#define var_tau var_tau_hsoma
#define var_inf var_inf_hsoma
...
#define exp_n exp_n_hsoma
 double exp_n = 0;
#define toffset_n toffset_n_hsoma
 double toffset_n = 0;
#define tscale_n tscale_n_hsoma
 double tscale_n = 0;
#define tskew_n tskew_n_hsoma
 double tskew_n = 0;
#define vsteep_n vsteep_n_hsoma
 double vsteep_n = 0;
#define vhalf_n vhalf_n_hsoma
 double vhalf_n = 0;
 ...
 "vhalf_n_hsoma", &vhalf_n_hsoma,
 "vsteep_n_hsoma", &vsteep_n_hsoma,
 "tskew_n_hsoma", &tskew_n_hsoma,
 "tscale_n_hsoma", &tscale_n_hsoma,
 "toffset_n_hsoma", &toffset_n_hsoma,
 "exp_n_hsoma", &exp_n_hsoma,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 hsoma hsoma.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "HSOMA";
...
#if NMODL_TEXT
static const char* nmodl_filename = "hsoma.mod";
static const char* nmodl_file_text = 
