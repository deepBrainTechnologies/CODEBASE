%script_plot_SCALEDTOGETHER_january_2024.m
...
set(gca, 'LineWidth', 2);
set(gca, 'FontSize', 12);
saveas(figI,[figuresDIR '\January_2024_RESCALED_Boeing_Nvidia_Hitachi_Vodafone.png']);


fig2 = figure;
subplot(3,3,1)
scatter(dataHITACHI(:,5),dataVODAFONE(:,5),'*','LineWidth',3); hold all; axis equal;
xlabel('Hitachi versus Vodafone');axis square;
subplot(3,3,2)
scatter(dataHITACHI(:,5),dataBOEING(:,5),'*','LineWidth',3); hold all;axis equal;
xlabel('Hitachi versus Boeing');axis square;
subplot(3,3,3)
scatter(dataHITACHI(:,5),dataNVIDIA(:,5),'*','LineWidth',3); hold all;axis equal;
xlabel('Hitachi versus Nvidia');axis square;
%saveas(figI2, [figuresDIR '\January_2024_RESCALED_Hitachi_versus_others.png']);


%figI3 = figure;
subplot(3,3,4)
scatter(dataNVIDIA(:,5),dataVODAFONE(:,5),'*','LineWidth',3); hold all; axis equal;
xlabel('Nvidia versus Vodafone');axis square;
subplot(3,3,5)
scatter(dataNVIDIA(:,5),dataBOEING(:,5),'*','LineWidth',3); hold all;axis equal;
xlabel('Nvidia versus Boeing');axis square;
subplot(3,3,6)
scatter(dataNVIDIA(:,5),dataHITACHI(:,5),'*','LineWidth',3); hold all;axis equal;
xlabel('Nvidia versus Hitachi');axis square;
%saveas(figI3, [figuresDIR '\January_2024_RESCALED_Nvidia_versus_others.png']);


%figI4 = figure;
subplot(3,3,7)
scatter(dataVODAFONE(:,5),dataNVIDIA(:,5),'*','LineWidth',3); hold all; axis equal;
xlabel(' Vodafone versus Nvidia'); axis square; axis tight;
subplot(3,3,8)
scatter(dataVODAFONE(:,5),dataBOEING(:,5),'*','LineWidth',3); hold all;axis equal;
xlabel('Vodafone versus Boeing');axis square;
subplot(3,3,9)
scatter(dataVODAFONE(:,5),dataHITACHI(:,5),'*','LineWidth',3); hold all;axis equal;
xlabel('Vodafone versus Hitachi');axis square;
saveas(fig2, [figuresDIR '\January_2024_RESCALED_others_versus_others.png']);
...
saveas(fig3, [figuresDIR '\January_2024_RESCALED_JFKmeanTemp_versus_StockOpenPrice.png']);
